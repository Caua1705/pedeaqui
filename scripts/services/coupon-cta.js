...
//    Aí "Aplicar cupom" seria um botão que cobra às cegas, e o destino é o
//    cardápio.
//
...
(function () {
  ...
  function couponCta(coupon, contexto) {
    ...
    if (estado === 'applicable' || estado === undefined || estado === null || estado === '') {
      return { acao: ACOES.APLICAR, rotulo: 'Aplicar cupom' };
    }
    ...
    // mandar para o cardápio nunca cobra nada de ninguém, e "Aplicar cupom"
